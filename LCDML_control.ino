...
// settings
  #define _LCDML_CONTROL_analog_pin              36
  // when you did not use a button set the value to zero
  #define _LCDML_CONTROL_analog_enter_min        2800     // Button Enter
  #define _LCDML_CONTROL_analog_enter_max        3800  
  #define _LCDML_CONTROL_analog_up_min           4000     // Button Up
  #define _LCDML_CONTROL_analog_up_max           4110   
  #define _LCDML_CONTROL_analog_down_min         2000     // Button Down
  #define _LCDML_CONTROL_analog_down_max         2500   
  #define _LCDML_CONTROL_analog_back_min         900     // Button Back
  #define _LCDML_CONTROL_analog_back_max         1200   
...
void lcdml_menu_control(void)
{
  ...
  if((millis() - g_LCDML_DISP_press_time) >= 200) {
    ...
    //Serial.println(value); // only for examples
...
// settings
  ...
  #define _LCDML_CONTROL_digital_enter           16    
  #define _LCDML_CONTROL_digital_up              17
...
// *********************************************************************
  ...
  // global defines
  #define encoder_A_pin       17    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  #define encoder_B_pin       5    // physical pin has to be 2 or 3 to use interrupts (on mega e.g. 20 or 21), use internal pullups
  ...
  MD_REncoder R = MD_REncoder(encoder_A_pin, encoder_B_pin);
  long  g_LCDML_CONTROL_Encoder_position = 0;
...
// *********************************************************************
{
  ...
  uint8_t x = R.read();
  if (x) { if (x == DIR_CW) 
    {g_LCDML_CONTROL_Encoder_position ++ ;
    } 
    else 
    {g_LCDML_CONTROL_Encoder_position -- ;}}
